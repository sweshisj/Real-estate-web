    ...
    <>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-neutral-600">
              Innovative marketing campaigns that capture attention and drive results.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-neutral-600">
              High-quality photos and videos that showcase your properties beautifully.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-neutral-600">
              Agile execution that helps you stand out and sell faster.
            </p>
          </div>
        </div>
      </div>
      ...
      <div ref={scrollref} className="relative w-full h-screen">
        <img
          ...
          src="https://wallpaperaccess.com/full/4401183.jpg"
          alt=""
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-center pl-8 pr-8">
          <h1 className="text-green-400 text-4xl md:text-6xl font-bold z-10">
            Build your dream project with <br></br> confidence
          </h1>
      ...
      <div className="py-12 bg-gray-100">
        ...
        <div className="flex justify-center flex-wrap gap-8">
          <img src="https://plus.unsplash.com/premium_photo-1682088156802-7a68b3e23f42?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y2xpZW50JTIwcGhvdG98ZW58MHx8MHx8fDA%3D" alt="Client 1" className=" w-[200px] h-[100px] object-cover opacity-70 hover:opacity-100 transition" />
          <img src="https://images.unsplash.com/photo-1542596594-649edbc13630?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGhhcHB5JTIwY2xpZW50fGVufDB8fDB8fHww" alt="Client 2" className=" w-[200px] h-[100px] object-cover opacity-70 hover:opacity-100 transition" />
          <img src="https://plus.unsplash.com/premium_photo-1681827754595-b2a610e2adb3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzN8fGhhcHB5JTIwcGVvcGxlfGVufDB8fDB8fHww" alt="Client 3" className=" w-[200px] h-[100px] object-cover opacity-70 hover:opacity-100 transition" />
          <img src="https://images.unsplash.com/photo-1541089404510-5c9a779841fc?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDB8fGhhcHB5JTIwcGVvcGxlfGVufDB8fDB8fHww" alt="Client 4" className=" w-[200px] h-[100px] object-cover opacity-70 hover:opacity-100 transition" />
        </div>
      </div>
    </>
  );
