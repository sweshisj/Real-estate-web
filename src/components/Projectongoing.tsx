...
function Projectongoing({ name, type, desc, location, img }: ProjectCardProps) {
return (
<>
<div className="w-[400px] h-[420px] ml-15 mt-8 bg-white shadow-xl">
<div className="p-4">
<div className="relative">
<img className="w-[370px] h-[275px] object-cover" src={img} alt={name} />
<p className="absolute top-2 left-0 bg-neutral-800 text-white text-sm font-medium rounded-tr-lg rounded-br-lg px-2 py-1.5">
{location}
</p>
</div>
